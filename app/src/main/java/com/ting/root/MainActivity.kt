...
private fun CustomPayloadCard(
    ...
    Card(
        ...
        Column(
            ...
            PayloadSourceChoice(
                title = stringResource(R.string.payload_source_s918u1_runner),
                detail = stringResource(R.string.payload_source_s918u1_runner_detail),
                selected = payloadSource == PayloadSource.S918U1Runner,
                enabled = enabled,
                onSelect = { onSourceChanged(PayloadSource.S918U1Runner) },
                onViewDetail = { detailSheet = PayloadSource.S918U1Runner },
            )
            PayloadSourceChoice(
    ...
    when (detailSheet) {
        ...
        PayloadSource.S918U1Runner -> PayloadSourceDetailSheet(
            title = stringResource(R.string.payload_detail_s918u1_runner_title),
            note = stringResource(R.string.payload_detail_s918u1_runner_note),
            entries = s918u1RunnerSupportedDevices,
            kernelBadges = true,
            chipBadge = null,
            onDismiss = { detailSheet = null },
        )
...
private val s918u1RunnerSupportedDevices = listOf(
    SupportedDeviceEntry(
        "Galaxy S23 Ultra 美版",
        "SM-S918U1 · BP4A.251205.006.S918U1UES8FZG1",
        "5.15.189",
    ),
)
